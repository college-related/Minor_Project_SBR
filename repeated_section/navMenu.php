...
<?php if(isset($_SESSION['uId']) && isset($_SESSION['role']) && $_SESSION['role'] == 'admin') { ?>
    ...
    <li><a href="http://localhost/MINOR_PROJECT_SBR/PAGES/admin/admin-profile.php" class='<?php if($pageName == "admin-profile.php") { echo "active-link"; } ?>'><?=$lang['header']['profile-text']?></a></li>
<?php }else {?>
